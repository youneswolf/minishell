...
#    Updated: 2024/04/16 12:25:12 by ybellakr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILE = ft_cd.c minishell.c ft_utlils.c ft_give_token.c ft_put_node.c ft_syntax.c ft_red_args.c ft_free.c\
			ft_expand.c ft_env.c ft_remove_quote.c ft_holder_node.c ft_checking_files.c ft_ctrl_c.c ft_split.c ft_pwd.c ft_does_matche.c
...
$(NAME): $(OBJS)
	...
	@$(CC) $(LINKER) $^ -fsanitize=address -g -o $@ -L$(READLINEDIR)/lib
	@echo "$(GREEN)[====Executable file Compiled Successfully!====]$(RESET)"
